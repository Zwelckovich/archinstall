...
alias codeup="yamir && yain biome visual-studio-code-bin && uv self update && bun upgrade && sudo claude update && code --update-extensions && sudo npm install -g @google/gemini-cli && sudo npm install -g corepack"

# --- LibreVNA GUI ---
alias librevna="/usr/bin/LibreVNA-GUI > /dev/null 2>&1 &"

# bun completions
[ -s "/home/zwelch/.bun/_bun" ] && source "/home/zwelch/.bun/_bun"
